    ...
    <header className="text-gray-400 bg-gray-900 body-font">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          ...
          <span className="ml-3 text-xl">Travel-World</span>
        </NavLink>
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
          <NavLink
            to="/home"
            className="mr-5 bg-green-500 text-black font-bold px-3 hover:bg-gray-300"
          ...
          {user.email ? (
            <div>
              <NavLink
                to="/myBookings"
                className="mr-5 bg-green-500 text-black font-bold px-3 py-1 hover:bg-gray-300 hover:bg-gray-300"
              >
                My Bookings
              </NavLink>
              <NavLink
          ...
          <NavLink
            to="/contact"
            className="mr-5 bg-green-500 text-black font-bold px-3 hover:bg-gray-300 hover:bg-gray-300"
            style={{ padding: "2px 10px" }}
          >
            Contact
          </NavLink>
