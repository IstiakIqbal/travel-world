    ...
    <div className="flex justify-center lg:my-20">
      ...
      >
        ...
        <div className="relative mb-4">
          ...
          <textarea
            ref={detailsRef}
            className="w-full h-60 bg-white rounded border border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            required
          />
        </div>
        <div className="relative mb-4">
